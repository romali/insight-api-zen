...
BlockController.prototype.getPoolInfo = function(block) {
    var self = this;
    var address = block.transactions[0].outputs[0].script.toAddress(self.node.network);
    console.log(address.toString('utf-8').orange)
    //var outputAddress = block.tx.outputs[0].address;

    //console.log(outputAddress.toString('utf-8').orange)
  ...
  if (block.transactions[0].inputs[0]) {
    ...
    //if (coinbaseBuffer != 'utf-8') {
    //  coinbaseBuffer = iconv.decode(coinbaseBuffer, 'win1251');
    //  console.log((coinbaseBuffer).blue);
    //}
    //console.log(coinbaseBuffer.toString('utf-8').red)
    //console.log(coinbaseBuffer.toString('ascii').yellow)
    //console.log(coinbaseBuffer.toString('utf16le').blue)
    //console.log(coinbaseBuffer.toString('hex').green)
